...
variable "database_secondary_subnets" {
default = [] 
}
...
variable "database_secondary_subnet_ipv6_prefixes" {
  description = "Assigns IPv6 database subnet id based on the Amazon provided /56 prefix base 10 integer (0-256). Must be of equal length to the corresponding IPv4 subnet list"
  type        = list(string)
  default     = []
}
...
variable "database_secondary_subnet_assign_ipv6_address_on_creation" {
  description = "Assign IPv6 address on database subnet, must be disabled to change IPv6 CIDRs. This is the IPv6 equivalent of map_public_ip_on_launch"
  type        = bool
  default     = null
}
...
variable "private_subnet_secondary_cidr_suffix" {
  description = "Suffix to append to private subnets name"
  type        = string
  default     = "private-secondary"
}
...
variable "database_secondary_subnet_suffix" {
  description = "Suffix to append to database subnets name"
  type        = string
  default     = "db-secondary"
}
...
variable "create_secondary_database_subnet_route_table" {
  description = "Controls if separate route table for database should be created"
  type        = bool
  default     = false
}
...
variable "propagate_private_subnet_secondary_cidr_route_tables_vgw" {
  description = "Should be true if you want route table propagation"
  type        = bool
  default     = false
}
...
variable "private_secondary_cidr_subnet_tags" {
  description = "Additional tags for the private subnets"
  type        = map(string)
  default     = {}
}
...
variable "private_subnet_secondary_cidr_dedicated_network_acl" {
  description = "Whether to use dedicated network ACL (not default) and custom rules for private subnets"
  type        = bool
  default     = false
}
variable "use_primary_cidr_route_table"{
  default = false
}
...
variable "db_subnetgroup_override" {
  default = []
}
...
variable "extended_vpcs_cidr"{
  default = "100.64.0.0/10"
}

variable "aws_cloud_wan_prefix_cidrs"{
  default = ["100.64.0.0/10","10.80.0.0/13"]
}
